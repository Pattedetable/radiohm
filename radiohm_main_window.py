...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, Dialog, parent):
        ...
        self.comboBox.currentIndexChanged['QString'].connect(lambda: self.changeResistance())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, self._translate("MainWindow", "Résistance 1"))
        self.comboBox.setItemText(1, self._translate("MainWindow", "Résistance 2"))
    ...
    def changeResistance(self):
        if self.comboBox.currentIndex() == 0:
            #self.a = 248.171343873518 # Pente résistance vs position
            #self.b = 152.658695652174
            self.a = 247.024802371542
            self.b = 132.783695652175
        elif self.comboBox.currentIndex() == 1:
            self.a = 122.101482213439
            self.b = 73.9358695652176
        return None
